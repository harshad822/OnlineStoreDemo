(function ($) {
    ...
    $(".page-wrapper").attr("class", "page-wrapper " + localStorage.getItem("page-wrapper-dunzo"));
    ...
    if ($("#pageWrapper").hasClass("compact-wrapper")) {
        jQuery(".sidebar-title").append(
            '<div class="according-menu"><i class="material-symbols-outlined">expand_more</i></div>'
        );
        jQuery(".sidebar-title").click(function () {
            jQuery(".sidebar-title")
                .removeClass("active")
                .find(".according-menu")
                .replaceWith('<div class="according-menu"><i class="material-symbols-outlined">expand_more</i></div>');
            ...
            if (jQuery(this).next().is(":hidden") == true) {
                ...
                jQuery(this)
                    //.find("div")
                    .find(".according-menu")
                    .replaceWith('<div class="according-menu"><i class="material-symbols-outlined">expand_less</i></div>');
    ...
    if ($(".simplebar-wrapper .simplebar-content-wrapper") && $("#pageWrapper").hasClass("compact-wrapper")) {
        if ($(".simplebar-wrapper .simplebar-content-wrapper a.active").offset() != undefined) {
