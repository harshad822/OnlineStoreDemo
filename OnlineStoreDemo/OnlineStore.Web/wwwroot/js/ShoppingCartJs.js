                ...
                data: 'quantity', className: 'td-number', render: function (data, type, row) {
                    return `<div class="input-group input-group-sm">
                            <div class="btn-group btn-group-sm">
                                <button class="btn btn-round btn-dark" onclick="updateQuantity(${row.id}, -1)"> <i class="material-symbols-outlined">remove</i> </button>
                                <input type="text" class="form-control text-center quantity mx-1" style="max-width: 50px;" value="${data}" readonly>
                                <button class="btn btn-round btn-dark" onclick="updateQuantity(${row.id}, 1)"> <i class="material-symbols-outlined">add</i> </button>
                            </div>`;
                }
            },
            {
